  ...
  <div class="Stocks">
    ...
    <div class="total">
      <h3>
        ...
        <span><input type="column" :value="total"/></span>
      </h3>
    </div>
    <div class="search">
      <b-row>
    ...
    computed: {
      ...
      total() {
        return Object.values(this.items).reduce(
          (accumulator, value) => accumulator + value.stocks_trend_24h,
          0
        )
      }
    }
